 ...
 *
 * @apiNote Позволяет обобщённо описать поведение метода или конструктора.
 * @since 1.0.0-RC1
 */
@Documented
...
public @interface Contract {
     ...
     * <p>
     * 1. Пробелы между словами игнорируются, поэтому рекомендуется использовать их для повышения его
     * читаемости.
     * </p>
     * <p>
    ...
    /**
     * Возвращает воздействие на контекст.
     *
     * @return Воздействие на контекст.
     *
     * @apiNote По умолчанию возвращается отсутствие воздействия на контекст.
     * @since 3.0.0-RC1
     */
    @Contract("-> const") Impact impact() default Impact.NONE;

    /**
     * Воздействие на контекст.
     *
     * @since 3.0.0-RC1
     */
    enum Impact {
        ...
        /**
         * Отсутствие воздействия на контекст.
         *
         * @apiNote Данное воздействие на контекст может быть применимо, например, к геттерам и сеттерам.
         * @since 3.0.0-RC1
         */
        NONE,

        /**
         * Слабое воздействие на контекст.
         *
         * @apiNote Данное воздействие на контекст может быть применимо, например, к конструкторам и методам,
         * затрагивающим внутренний контекст.
         * @since 3.0.0-RC1
         */
        WEAK,

        /**
         * Сильное воздействие на контекст.
         *
         * @apiNote Данное воздействие на контекст может быть применимо, например, к конструкторам и к методам,
         * затрагивающим внешний контекст.
         * @since 3.0.0-RC1
         */
        STRONG
