 ...
 *
 * @apiNote Эта аннотация активно изменялась, вплоть до выпуска 3.0.0-RC1, после чего планируется допускать лишь
...
public @interface Contract {
     ...
     *
     * @apiNote Этот параметр активно изменялся, вплоть до выпуска 3.0.0-RC1, после чего планируется допускать лишь
     ...
     *
     * @apiNote Этот параметр введён в выпуске 3.0.0-RC1, после чего планируется допускать лишь небольшие изменения в
     * его документации.
     * @implSpec Реализация этого параметра по умолчанию является эталонной, так как она полностью следует <a
     * href="https://github.com/Bloogefest/BF.Annotation/wiki/Contract#спецификация">спецификации</a>.
     * @implNote Для того чтобы применение этого параметра было максимально эффективно, следуйте <a
     ...
     *
     * @apiNote Это перечисление введено в выпуске 3.0.0-RC1, после чего планируется допускать лишь небольшие изменения
     * в её документации.
    ...
    enum Impact {
         ...
         *
         * @apiNote Это значение введено в выпуске 3.0.0-RC1, после чего планируется допускать лишь небольшие изменения
         * в его документации.
